...
public class PooledConnection implements Connection, Comparable<PooledConnection> {
     ...
     *
     * @param connection for adding to pool
     */
     ...
     * that may fail. If this method returns true then calling
     ...
     * object or a proxy for the wrapped object. Otherwise return the the result
     * of calling <code>unwrap</code> recursively on the wrapped object or
     ...
     *                      connection or this <code>Connection</code> object
     ...
     *                 to. The typeName is a database-specific name which may be
     *                 the name of a built-in type, a user-defined type or a
     *                 standard  SQL type supported by this database. This is
     *                 the value returned by <code>Array.getBaseTypeName</code>
     * @param elements the elements that populate the returned object
     * @return an Array object whose elements map to the specified SQL type
     * @throws SQLException                    if a database error occurs,
     *                                         the JDBC type is not appropriate
     *                                         for the typeName and the
     *                                         conversion is not supported,
     *                                         the typeName is null or this
     ...
     * The <code>setBinaryStream</code> and <code>setBytes</code> methods of the
     ...
     *                                         not be constructed, this method
     ...
     * method of the <code>SQLXML</code> interface may be used to add data
     * to the <code>SQLXML</code> object.
     *
     * @return An object that implements the <code>SQLXML</code> interface
     * @throws SQLException                    if an object that implements the
     *                                         <code>SQLXML</code> interface can
     *                                         not be constructed, this method
     *                                         is called on a closed connection
     *                                         or a database access error
     *                                         occurs.
     ...
     *                                         method is not supported for the
     *                                         specified result set type and
     ...
     *                                         this method or this method is not
     *                                         supported for the specified result
     *                                         set type, result set holdability
     ...
     * <ul>
     * <li>For DML statements, such as Insert, Update or Delete,
     * and DDL statements, the statement is complete as soon as it has finished
     * executing.
     ...
     * associated result sets have been closed, and all update
     ...
     * a DBMS* prepare operation takes place immediately when
     * the {@code Connection} method {@code prepareStatement} or
     * {@code prepareCall} is invoked. For maximum portability,
     * {@code setCatalog} should be called before a {@code Statement} is created
     * or prepared.
     *
     ...
     * which client info properties were not set.
     ...
     * <code>Properties</code> object contains the names and values of the
     * client info properties to be set.  The set of client info properties
     * contained in the properties list replaces the current set of client
     * info properties on the connection.  If a property that is currently set
     * on the* connection is not present in the properties list, that property is
     * cleared.  Specifying an empty properties list will clear all of the
     * properties on the connection.
     * See <code>setClientInfo (String, String)</code> for more information.
     * <p>
     ...
     * <code>SQLClientInfoException</code> is thrown.
     * The <code>SQLClientInfoException</code> contains information indicating
     * which client info properties were not set. The state of the client
     * information is unknown because some databases do not allow multiple
     * client info properties to be set atomically.  For those databases,
     * one or more properties may have been set before the error occurred.
     * <p>
     *
     * @param properties the list of client info properties to set
     *                   <p>
     ...
     */
    @Override
    public String getClientInfo(final String properties) throws SQLException {
        return connection.getClientInfo(properties);
    }
     ...
     *                                         parameter is not a
     *                                         <code>ResultSet</code> constant
     *                                         indicating holdability
     * @throws SQLFeatureNotSupportedException if the given holdability is not
     *                                         supported
     * @see #getHoldability
     * @see DatabaseMetaData#getResultSetHoldability
     * @see ResultSet
     ...
     *                                         is not a <code>java.util.Map</code>
     *                                         object
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this method
     * @see #getTypeMap
     ...
     */
    @Override
    public void setReadOnly(boolean catalog) throws SQLException {
        connection.setReadOnly(catalog);
    }
     ...
     *                                         returned
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this method with a constant of
     ...
     * is not an <code>INSERT</code> statement, or an SQL statement able to
     * return auto-generated keys (the list of such statements
     * is vendor-specific).
     * <p>
     * An SQL statement with or without IN parameters can be
     * pre-compiled and stored in a <code>PreparedStatement</code> object. This
     ...
     *                                         is not a valid savepoint in the
     *                                         current transaction
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not
     *                                         support this method
     */
     ...
     *                                         on a closed connection,
     *                                         the <code>Savepoint</code> object
     ...
     * If the driver generates a <code>SQLClientInfoException</code>, the value
     ...
     *              <p>
     * @throws SQLClientInfoException if the database server returns an error
     *                                while setting the client info value on
     *                                the database server or this method
     *                                is called on a closed connection
     *                                <p>
     */
    @Override
     ...
     *                     milliseconds, the JDBC driver will round the value
     *                     up to the nearest second.  If the timeout period
     *                     expires before the operation completes, a SQLException
     *                     will be thrown. A value of 0 indicates that there
     *                     is not timeout for database operations.
     * @throws java.sql.SQLException           if a database access error occurs,
     *                                         this method is called on a closed
     *                                         connection, the {@code executor}
     *                                         is {@code null}, or the value
     *                                         specified for <code>seconds</code>
     *                                         is less than 0.
     * @throws java.lang.SecurityException     if a security manager exists and its
     *                                         <code>checkPermission</code> method
     *                                         denies calling
     ...
     * Compare connections.
     *
     * @param connection to compare
     * @return difference between hash codes
     */
    @Override
